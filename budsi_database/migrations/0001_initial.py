...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["user", "invoice_type"], name="budsi_datab_user_id_aaa12f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["user", "is_credit_note"], name="budsi_datab_user_id_4dbad8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["user", "due_date"], name="budsi_datab_user_id_e916da_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="invoice",
