...
# Modelos
from emerg_database.models import Invoice, FiscalProfile
...
def faqs_view(request):
    ...
    return render(request, "emergency_app/dash/help_support/faqs.html")

@login_required
def balance_overview_view(request):
    """Vista de balance financiero"""
    context = {"message": "Financial overview section - under development"}
    return render(request, "emergency_app/dash/finances/balance_overview.html", context)

@login_required
def reminders_view(request):
    """Vista de recordatorios"""
    return render(request, "emergency_app/reminders.html")

@login_required
def flow_view(request):
    """Vista de flujo"""
    return render(request, "emergency_app/dash/flow/flow.html")

@login_required
def pulse_view(request):
    """Vista de pulse"""
    return render(request, "emergency_app/dash/pulse/main_pulse.html")

@login_required
def buzz_view(request):
    """Vista de buzz"""
    return render(request, "emergency_app/dash/buzz/buzz.html")

@login_required
def nest_view(request):
    """Vista de nest"""
    return render(request, "emergency_app/dash/nest/nest.html")

@login_required
def whiz_view(request):
    """Vista de whiz"""
    return render(request, "emergency_app/dash/whiz/whiz.html")

@login_required
def help_view(request):
    """Vista de ayuda"""
    return render(request, "emergency_app/dash/help_support/support.html")
...
def main_track_view(request):
    ...
    return render(request, "emergency_app/dash/track/main_track.html")
...
def credit_note_create_view(request):
    ...
    try:
        profile = FiscalProfile.objects.get(user=request.user)
        return render(request, "emergency_app/dash/invoice/credite_note.html", {"profile": profile})
    except FiscalProfile.DoesNotExist:
        messages.error(request, "Please complete your fiscal profile first")
        return redirect("onboarding")
...
def dashboard_view(request):
    ...
    try:
        ...
        return render(request, 'emergency_app/dashboard.html', {
            "monthly_income": [],
...
def legal_templates_view(request):
    ...
    return render(request, "emergency_app/dash/doc/legal_templates.html")

@login_required
def service_agreement_form_view(request):
    """Formulario de Service Agreement"""
    return render(request, "emergency_app/dash/doc/docs_slaves /service_agreement.html")

@login_required
def project_proposal_form_view(request):
    """Formulario de Project Proposal"""  
    return render(request, "emergency_app/dash/doc/docs_slaves /project_proposal.html")

@login_required
def time_sheet_form_view(request):
    """Formulario de Time Sheet"""
    return render(request, "emergency_app/dash/doc/docs_slaves /time_sheet.html")

@login_required
def non_disclosure_form_view(request):
    """Formulario de Non-Disclosure Agreement"""
    return render(request, "emergency_app/dash/doc/docs_slaves /non_disclosure.html")

@login_required
def statement_of_work_form_view(request):
    """Formulario de Statement of Work"""
    return render(request, "emergency_app/dash/doc/docs_slaves /statement_of_work.html")
